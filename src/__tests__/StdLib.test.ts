...
describe('list', () => {
  ...
  describe('cadr', () => {
    test('returns the second element in the list', () => {
      expect(evaluateUntilDone("(cadr '(1 2 3))")).toEqual(makeNumber(2))
    })
  })

  describe('caddr', () => {
    test('returns the third element in the list', () => {
      expect(evaluateUntilDone("(caddr '(1 2 3))")).toEqual(makeNumber(3))
    })
  })

  describe('cadddr', () => {
    test('returns the fourth element in the list', () => {
      expect(evaluateUntilDone("(cadddr '(1 2 3 4))")).toEqual(makeNumber(4))
    })
  })
